document.addEventListener('DOMContentLoaded', function() {
    ...
    const apps = [
        ...
        },
        {
            ...
            description: 'Advanced AI trading bot using CoW Protocol with optimized limit orders.<br>• Automated trading strategies<br>• Real-time market analysis<br>• Risk management<br>• Telegram notifications',
        ...
        },
        {
            ...
            description: 'Automated rebalancing on Base using CoW Protocol. Tracks performance vs HODL.<br>• Custom target allocations<br>• Supports cbBTC, WETH, cbXRP, cbADA, DOGE, AAVE<br>• Telegram alerts<br>• More coins coming soon',
        ...
        },
        {
            ...
            description: 'Real-time crypto market analysis with institutional-grade data visualization.<br>• Macro indicators<br>• Market sentiment analysis<br>• Advanced charting tools<br>• Key metrics and correlations',
